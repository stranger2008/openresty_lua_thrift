require "test.rpc_RpcService"
require "libthrift.TFramedTransport"
require "libthrift.TBinaryProtocol"
require "libthrift.TJsonProtocol"
require "libthrift.TCompactProtocol"
require "libthrift.TSocket"
_M = {}
